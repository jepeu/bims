          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="/bims/about.html">About Us
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="<?php echo base_url()."assets/";?>custom/assets/images/about-image.jpg" alt="">
                  </div>
                </div>
              </div>
            </div>
    ...
    <!-- <div class="team">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="team-item">
              <img src="<?php echo base_url()."assets/";?>custom/assets/images/team_01.jpg" alt="">
          ...
          <div class="col-md-4">
            <div class="team-item">
              <img src="<?php echo base_url()."assets/";?>custom/assets/images/team_02.jpg" alt="">
              <div class="down-content">
                <h4>Mary Houston</h4>
          ...
          <div class="col-md-4">
            <div class="team-item">
              <img src="<?php echo base_url()."assets/";?>custom/assets/images/team_03.jpg" alt="">
              <div class="down-content">
                <h4>Paul Walker</h4>
